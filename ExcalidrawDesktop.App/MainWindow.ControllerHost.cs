...
public sealed partial class MainWindow : IDocumentLifecycleHost, IWindowCloseHost, IImageExportHost
{
    ...
    Task IWindowCloseHost.PersistApplicationWorkspaceAsync() => workspaceCoordinator.PersistWorkspaceAsync();
    ...
    Task<bool> IWindowCloseHost.EnterCloseBarrierAsync(IReadOnlyList<DocumentSession> targets) => EnterCloseBarrierAsync(targets);
    ...
    Microsoft.UI.Xaml.XamlRoot? IImageExportHost.DialogRoot => DocumentTabs.XamlRoot;
